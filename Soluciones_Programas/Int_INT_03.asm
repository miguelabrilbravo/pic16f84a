...
; que es visualizado en el módulo LCD. Si se mantiene pulsado se incrementa cada 200 ms.
...
Inicio
	...
	movwf	INTCON
Principal
	sleep				; Pasa a modo de bajo consumo y espera interrupciones.
	goto	Principal
...
VisualizaContador
	...
	call	LCD_Byte
	call	Retardo_200ms		; Espera este tiempo para volver a incrementar.
	btfss	Pulsador		; ¿Sigue pulsado?
	goto	Incrementa		; Sigue pulsado, salta a incrementar y visualizar.
FinInterrupcion
	bcf	INTCON,INTF		; Limpia flags de reconocimiento (INTF).
