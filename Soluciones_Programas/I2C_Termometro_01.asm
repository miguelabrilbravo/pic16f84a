...
Inicio	call	DS1624_Inicializa		; Configura el DS1624 e inicia la conversión.
	...
	movwf	Registro50ms
	movlw	b'10101000'		; Activa interrupción del TMR0 (T0IE), por cambio en
	movwf	INTCON			; las líneas del Puerto B (RBIE) y la general (GIE).
Principal
	goto	Principal
